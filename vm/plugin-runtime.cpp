...
static const NativeMapping sNativeMap[] = {
  ...
  { "float",                OP_FLOAT },
  { "floatdb",              OP_DOUBLE_TO_FLOAT }, // why am i doing this
  ...
  { "DoubleAbs",            OP_DBABS },
  { "DoubleAdd",            OP_DOUBLEADD },
  { "DoubleSub",            OP_DOUBLESUB },
  { "DoubleMul",            OP_DOUBLEMUL },
  { "DoubleDiv",            OP_DOUBLEDIV },
  { "double",               OP_DOUBLE },
  { "doublef",              OP_FLOAT_TO_DOUBLE },
  { "DoubleCompare",        OP_DOUBLECMP },
  { "DoubleRoundToCeil",    OP_RND_TO_CEIL_DOUBLE },
  { "DoubleRoundToZero",    OP_RND_TO_ZERO_DOUBLE },
  { "DoubleRoundToFloor",   OP_RND_TO_FLOOR_DOUBLE },
  { "DoubleRoundToNearest", OP_RND_TO_NEAREST_DOUBLE },
  { "__DOUBLE_GT__",        OP_DOUBLE_GT },
  { "__DOUBLE_GE__",        OP_DOUBLE_GE },
  { "__DOUBLE_LT__",        OP_DOUBLE_LT },
  { "__DOUBLE_LE__",        OP_DOUBLE_LE },
  { "__DOUBLE_EQ__",        OP_DOUBLE_EQ },
  { "__DOUBLE_NE__",        OP_DOUBLE_NE },
  { "__DOUBLE_NOT__",       OP_DOUBLE_NOT },
  ...
  { "__double_float",       OP_FLOAT },
  { "__float_ctor",         OP_DOUBLE_TO_FLOAT },
  ...
  { "__double_add",         OP_DOUBLEADD },
  { "__double_sub",         OP_DOUBLESUB },
  { "__double_mul",         OP_DOUBLEMUL },
  { "__double_div",         OP_DOUBLEDIV },
  { "__double_mod",         OP_NOP }, // No asm version
  { "__double_ctor",        OP_DOUBLE },
  { "__float_double",       OP_FLOAT_TO_DOUBLE },
  { "__double_gt",          OP_DOUBLE_GT },
  { "__double_ge",          OP_DOUBLE_GE },
  { "__double_lt",          OP_DOUBLE_LT },
  { "__double_le",          OP_DOUBLE_LE },
  { "__double_eq",          OP_DOUBLE_EQ },
  { "__double_ne",          OP_DOUBLE_NE },
  { "__double_not",         OP_DOUBLE_NOT },
